...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0984[0x8];                                   // 0x0468(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_M48S[0x6];                                   // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TSL1[0x4];                                   // 0x04BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
