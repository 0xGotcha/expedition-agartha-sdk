...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OEVG[0x80];                                  // 0x0048(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PB5L[0x6];                                   // 0x00CA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YI19[0x7];                                   // 0x00E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E13B[0x40];                                  // 0x0120(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_YDRD[0x20];                                  // 0x0048(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B8KS[0x6];                                   // 0x006A(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		class FString                                              FileNameFormat;                                          // 0x0048(0x0010) Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_GY7H[0x18];                                  // 0x0058(0x0018) MISSED OFFSET (PADDING)
