...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function AsyncLoadingScreen.AsyncLoadingScreenLibrary.StopLoadingScreen
	 * 		Flags  -> ()
	 */
	void UAsyncLoadingScreenLibrary::StopLoadingScreen()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AsyncLoadingScreen.AsyncLoadingScreenLibrary.StopLoadingScreen");
