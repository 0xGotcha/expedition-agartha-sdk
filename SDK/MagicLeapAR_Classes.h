...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZZY0[0xA8];                                  // 0x0238(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F03K[0x3];                                   // 0x0179(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V1N9[0x6];                                   // 0x019A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6PL2[0x5];                                   // 0x005B(0x0005) MISSED OFFSET (PADDING)
