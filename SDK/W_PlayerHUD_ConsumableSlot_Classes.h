...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass W_PlayerHUD_ConsumableSlot.W_PlayerHUD_ConsumableSlot_C
	 * Size -> 0x0030 (FullSize[0x0290] - InheritedSize[0x0260])
	 */
	class UW_PlayerHUD_ConsumableSlot_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_W_PlayerHUD_ConsumableSlot(int32_t EntryPoint);
